        ...
        child:Column(crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
              Container(padding: EdgeInsets.symmetric(horizontal: 5),
                  child:Text("EMPLOYEES",style:TextStyle(fontSize:15,fontWeight: FontWeight.w700))
              ),
                    ...
                    children: <Widget>[
                      Container(width: 80,
                        ...
                        decoration: BoxDecoration(
                          border: Border.all(color: Color(0xffE52897),width: 1.5),
                          ...
                          if(dataSnapshot != null){
                            return Table(
                                ...
                                children: [
                                  TableRow(
                                      children: [
                                        Container(padding:EdgeInsets.all(10),color: Color(0xFFC6BFC3),child: Text("EMPLOYEE",style: TextStyle(fontSize: 10),textAlign: TextAlign.center,)),
                                        Container(padding:EdgeInsets.all(10),color:Color(0xFFC6BFC3),child: Text("CONTACT INFORMATION",textAlign: TextAlign.center,style: TextStyle(fontSize: 10))),
                                        Container(padding:EdgeInsets.all(10),color:Color(0xFFC6BFC3),child: Text("SCHEDULE",textAlign: TextAlign.center,style: TextStyle(fontSize: 10))),
